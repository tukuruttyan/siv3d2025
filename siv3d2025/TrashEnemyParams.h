...
#define DEFINE_TRASH_ENEMY_FUNC(NAME, ...) \
	...
	DEFINE_TRASH_ENEMY_FUNC(TRASH_BAG, 0.5f, 1.5f, 0.2f, 0.2f, 2, 1, 3, 0, 10.0f, 0, s3d::Vec2{ 100, 100 }, SpriteAnimation{ U"Akikan.png", 3, 1, 1.0f}, SpriteAnimation{ U"Akikan.png", 3, 1, 1.0f});
}
